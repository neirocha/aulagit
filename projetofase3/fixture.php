...
$linha2 = array('Dados da pagina inicial', 'Navegue em nossa Empresa<br>*Estes dados estao vindo da base de dados.', 'Todos os nossos Produtos', 'Prestacao de Servicos', 'preencha o nosso formulario em nosso Contatos');
for($x = 0; $x <= 4; $x++){
